...
{
  boost::shared_ptr<HdfFile> hfile(new HdfFile(test_data_dir() + "in/oco_L1bSun03CO2ND_91605a_081028154658t_spliced.hdf"));
...
{
  boost::shared_ptr<HdfFile> hfile(new HdfFile(test_data_dir() + "in/oco2_L1bScND_80008a_111017225030d_spliced.h5"));
